    ...
    st.markdown(f'''
        ...
        <div class="notion-nav-container">
            ...
            <div class="notion-nav-links">
                ...
                <a class="notion-nav-item" href="/pages/01_Schedule" target="_self">📅 {t('nav_schedule')}</a>
                <a class="notion-nav-item active" href="/pages/02_About" target="_self">✨ {t('nav_about')}</a>
            </div>
